...
export default function profile() {
    ...
    return (
        ...
        <div class="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <img class="object-cover object-center w-full h-56" src={qrcode} alt="avatar"/>
            ...
            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{response.username}</h1>
